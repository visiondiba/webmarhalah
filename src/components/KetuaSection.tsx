      ...
      <div className="px-10 md:px-16 pt-16 pb-10">
        <GlitchText delay={0.1}>
          ...
          <h1
            ...
            style={{ color: "#5A2C18" }}
          >
            Our <span style={{ color: "#B8873A" }}>Prime Catalyst.</span>
          </h1>
        </GlitchText>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 flex-1 min-h-[70vh]">
        {data.map((ketua, i) => (
          <motion.div
            ...
            style={{
              borderRight: i < data.length - 1 ? "5px solid #B8873A15" : "none",
            }}
          >
            ...
            <div className="relative w-full overflow-hidden" style={{ height: 800 }}>
              <motion.div
                ...
                animate={{ clipPath: "inset(0% 0 0 0)" }} // ← ganti whileInView ke animate
